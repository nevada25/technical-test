package com.ibk.reto.tecnico.auth.msvcauth.services;

import com.ibk.reto.tecnico.auth.msvcauth.models.Usuario;
    ...
    public UserDetails loadUserByUsername(String email) throws UsernameNotFoundException {
        try {
            ...
            Usuario usuario = client
                    .build()
                    .get()
                    .uri("http://localhost:8003/login", uri -> uri.queryParam("email", email).build())
